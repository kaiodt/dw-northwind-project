    ...
    USE [DW_SILVER];
    EXEC('
        create view "dbo"."SLV_CUSTOMERS__customers__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "DW_SILVER"."dbo"."SLV_CUSTOMERS__customers" FROM "DW_SILVER"."dbo"."SLV_CUSTOMERS__customers__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS dbo.SLV_CUSTOMERS__customers__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'dbo_SLV_CUSTOMERS__customers_cci'
        AND object_id=object_id('dbo_SLV_CUSTOMERS__customers')
    )
    DROP index "dbo"."SLV_CUSTOMERS__customers".dbo_SLV_CUSTOMERS__customers_cci
    CREATE CLUSTERED COLUMNSTORE INDEX dbo_SLV_CUSTOMERS__customers_cci
    ON "dbo"."SLV_CUSTOMERS__customers"
