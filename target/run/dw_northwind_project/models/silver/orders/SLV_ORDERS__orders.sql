    ...
    USE [DW_SILVER];
    EXEC('
        create view "dbo"."SLV_ORDERS__orders__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "DW_SILVER"."dbo"."SLV_ORDERS__orders" FROM "DW_SILVER"."dbo"."SLV_ORDERS__orders__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS dbo.SLV_ORDERS__orders__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'dbo_SLV_ORDERS__orders_cci'
        AND object_id=object_id('dbo_SLV_ORDERS__orders')
    )
    DROP index "dbo"."SLV_ORDERS__orders".dbo_SLV_ORDERS__orders_cci
    CREATE CLUSTERED COLUMNSTORE INDEX dbo_SLV_ORDERS__orders_cci
    ON "dbo"."SLV_ORDERS__orders"
