    ...
    USE [DW_SILVER];
    EXEC('
        create view "dbo"."SLV_PRODUCTS__products__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "DW_SILVER"."dbo"."SLV_PRODUCTS__products" FROM "DW_SILVER"."dbo"."SLV_PRODUCTS__products__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS dbo.SLV_PRODUCTS__products__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'dbo_SLV_PRODUCTS__products_cci'
        AND object_id=object_id('dbo_SLV_PRODUCTS__products')
    )
    DROP index "dbo"."SLV_PRODUCTS__products".dbo_SLV_PRODUCTS__products_cci
    CREATE CLUSTERED COLUMNSTORE INDEX dbo_SLV_PRODUCTS__products_cci
    ON "dbo"."SLV_PRODUCTS__products"
