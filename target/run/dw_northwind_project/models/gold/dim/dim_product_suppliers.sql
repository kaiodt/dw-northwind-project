    ...
    USE [DW_GOLD];
    EXEC('
        create view "dbo"."dim_product_suppliers__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "DW_GOLD"."dbo"."dim_product_suppliers" FROM "DW_GOLD"."dbo"."dim_product_suppliers__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS dbo.dim_product_suppliers__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'dbo_dim_product_suppliers_cci'
        AND object_id=object_id('dbo_dim_product_suppliers')
    )
    DROP index "dbo"."dim_product_suppliers".dbo_dim_product_suppliers_cci
    CREATE CLUSTERED COLUMNSTORE INDEX dbo_dim_product_suppliers_cci
    ON "dbo"."dim_product_suppliers"
